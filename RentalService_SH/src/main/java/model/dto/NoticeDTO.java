...
public class NoticeDTO {
	...
	public NoticeDTO(int no, String title, String content, Timestamp regDate, int viewCount, int like) {
		this.no=no;this.title=title;this.content=content;this.regDate=regDate;this.viewCount=viewCount; this.like=like;
	}
	public NoticeDTO(String title, String content, Timestamp regDate) {
